...
<div style="width:100%;max-width:720px;margin:1.5rem auto;">
  <a href="https://www.youtube.com/watch?v=angmcGqg-C8" target="_blank" rel="noopener noreferrer" style="display:block;position:relative;aspect-ratio:16/9;border-radius:0.5rem;overflow:hidden;background:#000;">
    <img src="https://i.ytimg.com/vi/angmcGqg-C8/hqdefault.jpg" alt="Watch the Software Factories talk on YouTube" width="1280" height="720" style="display:block;width:100%;height:100%;object-fit:cover;" />
    <span style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,0.25);" aria-hidden="true">
      <svg width="68" height="48" viewBox="0 0 68 48" xmlns="http://www.w3.org/2000/svg"><path d="M66.52 7.74c-.78-2.93-2.49-5.41-5.42-6.19C55.79.13 34 0 34 0S12.21.13 6.9 1.55c-2.93.78-4.63 3.26-5.42 6.19C.06 13.05 0 24 0 24s.06 10.95 1.48 16.26c.78 2.93 2.49 5.41 5.42 6.19C12.21 47.87 34 48 34 48s21.79-.13 27.1-1.55c2.93-.78 4.64-3.26 5.42-6.19C67.94 34.95 68 24 68 24s-.06-10.95-1.48-16.26z" fill="red"/><path d="M45 24 27 14v20" fill="white"/></svg>
    </span>
  </a>
</div>

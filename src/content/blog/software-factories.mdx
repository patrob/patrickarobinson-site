...
<div style="width:100%;max-width:720px;margin:1.5rem auto;">
  <iframe
    src="https://www.youtube-nocookie.com/embed/angmcGqg-C8"
    title="Software Factories — Alamo Agents Night One"
    loading="lazy"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowfullscreen
    style="display:block;width:100%;aspect-ratio:16/9;border:0;border-radius:0.5rem;"
  ></iframe>
</div>
